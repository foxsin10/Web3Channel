...
const maskDappChannel = window.maskDappChannel;
...
describe("MaskWeb3Provider constructor tests", () => {
  test("test constructor.name", () => {
    const provider = new maskDappChannel.Provider({});
    const web3 = new maskDappChannel.Web3(provider);
  ...
  test("test setConfig", (done) => {
    const provider = new maskDappChannel.Provider(ropsten);
